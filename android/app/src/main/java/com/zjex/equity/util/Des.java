...
public class Des {
	...
	private static final String KEY ="zjexZJEX";

//    public static void main(String[] args) {
//        String data = "https://support.google.com/chrome/?p=help&ctx=keyboard";
//        String str = Des.strEnc(data);
//        System.out.println(str);
//        String dec = Des.strDec(str);
//        System.out.println(dec);
//    }
    
    public static String strEnc(String password,String username ){
    	return strEnc(password,username,KEY,null);
    }
